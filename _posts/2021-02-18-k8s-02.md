...
```bash
wget -c --timestamping  https://pkg.cfssl.org/R1.2/cfssl_linux-amd64
...
ETCD_LISTEN_CLIENT_URLS="https://192.168.56.105:2379,http://127.0.0.1:2379"
...
ETCD_INITIAL_CLUSTER="etcd01=https://192.168.56.105:2380"
